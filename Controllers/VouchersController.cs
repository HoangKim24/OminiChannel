...
namespace Omnichannel.Controllers
{
    ...
    public class VouchersController : ControllerBase
    {
        ...
        public VouchersController(VoucherPricingService voucherPricingService)
        {
        ...
        [SwaggerOperation(
            ...
            Description = "API cho người dùng áp dụng một hoặc hai mã giảm giá và trả về chi tiết tính tiền: itemsSubtotal, shippingFee, orderVoucherDiscount, shippingVoucherDiscount, finalTotal. " +
                          "Ví dụ body: { userId: 2, itemsSubtotal: 120, shippingFee: 2.08, orderVoucherCode: 'WELCOME10', shippingVoucherCode: 'SHIP20K', salesChannelId: 1 }")]
